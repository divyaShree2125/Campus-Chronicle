                ...
                <div class="side-panel-links">
                    ...
                    <div class="pt-2"><span class="text-light">Notes</span>
                        ...
                        <a href="text_download.php">View</a>
                            ...
                            <a href="https://www.google.co.in">Update</a>
                        </div>
                    </div>
                    <hr class="bg-light ">
                    <div class="pt-3"><span class="text-light">Notice</span>
                        <div class="notice-content">
                            <a href="https://mynoticeboard.my.canva.site/chronicle">View</a>
                            <a href="admin_notice_u.html">Insert</a>
                            <a href="admin_notice_d.php">Delete</a>
                            <a href="https://www.google.co.in">Update</a>
                        </div>
                    </div>
                    <hr class="bg-light ">
                    <div class="pt-4"><span class="text-light">PYQ</span>
                        <div class="PYQ-content">
                            <a href="https://www.google.co.in">View</a>
                            <a href="https://www.google.co.in">Insert</a>
                            <a href="https://www.google.co.in">Delete</a>
                            <a href="https://www.google.co.in">Update</a>
                        </div>
                    </div>
                    <hr class="bg-light ">
               ...
               <div class="row">
                   ...
                   <div class="col-sm-2">
                       <p class="pt-5 text-center">
                            <a href="logout.php" class="btn btn-outline-primary">Logout</a>s
                       </p>
                   </div>
               </div>
               <div class="container mx-auto">
               
                <form action="delete_file1.php" method="POST"id="the-form" class="form-control w-50 mx-auto" enctype="multipart/form-data">
                <label for="file" class="form-label"><strong>Select file</strong></label><br>
                    <?php
                   
                    $sql = "SELECT id, filename FROM file_notice  ";
                ...
                <form action="delete_text1.php" method="POST"id="the-form" class="form-control w-50 mx-auto" enctype="multipart/form-data">
                <label for="file" class="form-label"><strong>Select text</strong></label><br>
                    <?php
                   
                    $sql2 = "SELECT id, textarea_content FROM text1_notice  ";
                ...
                <form action="detete_n_l1.php" method="POST"id="the-form" class="form-control w-50 mx-auto" enctype="multipart/form-data">
                <label for="file" class="form-label"><strong>Select links</strong></label><br>
                    <?php
                   
                    $sql1 = "SELECT id, textarea_content FROM text_notice  ";
